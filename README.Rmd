...
The bgmeter package allows you to periodically collect measurements in the background while your main R process continues running.

## Installation

You can install the development version of bgmeter from [GitHub](https://github.com/) with:
...
This example shows how to start and stop background measurements using `bgmeter`.
